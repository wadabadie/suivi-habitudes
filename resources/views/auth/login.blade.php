    ...
    <div class="hf-auth-card">
        ...
        <div class="hf-auth-icon">
           <a class="navbar-brand" href="{{ auth()->check() ? route('habitudes.index') : route('welcome') }}" style="flex-shrink:0;">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 40" width="900" height="300" aria-label="HabitFlow">
                ...
                <text x="40" y="16" font-family="'Playfair Display',Georgia,serif" font-size="60" font-weight="900" fill="var(--hf-texte)" letter-spacing="0.3">Habit</text>
                <text x="40" y="32" font-family="'DM Sans',system-ui,sans-serif" font-size="50.5" font-weight="800" fill="#2ecc71" letter-spacing="2.5">FLOW</text>
            </svg>
        </a>
        </div>
