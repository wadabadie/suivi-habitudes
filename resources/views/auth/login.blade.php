    ...
    <div class="hf-auth-card">
        ...
        <div class="hf-auth-icon">
           <a class="navbar-brand" href="{{ auth()->check() ? route('habitudes.index') : route('welcome') }}" style="flex-shrink:0;">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 40" width="800" height="100" aria-label="HabitFlow">
                ...
                <text x="40" y="16" font-family="'Playfair Display',Georgia,serif" font-size="52" font-weight="700" fill="var(--hf-texte)" letter-spacing="0.3">Habit</text>
                <text x="40" y="32" font-family="'DM Sans',system-ui,sans-serif" font-size="35.5" font-weight="600" fill="#2ecc71" letter-spacing="2.5">FLOW</text>
            </svg>
        </a>
        </div>
